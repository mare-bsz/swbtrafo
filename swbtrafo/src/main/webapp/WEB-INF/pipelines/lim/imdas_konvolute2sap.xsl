	...
	<xsl:template match="row">
		...
		<xsl:call-template name="ausgabe">	
			...
			<xsl:with-param name="kostenstelle">
				<xsl:choose>
						<xsl:when test="./field[@id='Eingangsart'] = 'Fund'"><xsl:text>7958300000</xsl:text></xsl:when>							
						<xsl:when test="./field[@id='Eingangsart'] = 'Kauf'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Spende'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Kauf (Zentralfond)'"><xsl:text>7958111111</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Kauf Museumsstiftung'"><xsl:text>7958111111</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Leihgabe'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Nachlaß'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Schenkung'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Tausch'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Überlassung'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Vermächtnis'"><xsl:text>7958300000</xsl:text></xsl:when>
						<xsl:when test="./field[@id='Eingangsart'] = 'Unbekannt'"><xsl:text>7958300000</xsl:text></xsl:when>
				</xsl:choose>		
			</xsl:with-param>						
